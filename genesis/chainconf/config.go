...
var (
	...
	ErrCouldntLocateConfig = errors.New("could not locate a config.yml in your chain. please follow the link for how-to: https://github.com/interchained/genesis/blob/develop/docs/configure/index.md")
