...
function install {
	...
	*) fail "unknown os: $(uname -s)";;
	...
	case "${OS}_${ARCH}" in
	"darwin_amd64")
		URL="https://github.com/interchained/genesis/releases/download/v0.1.1/genesis_0.1.1_darwin_amd64.tar.gz"
		FTYPE=".tar.gz"
		;;
	"linux_amd64")
		URL="https://github.com/interchained/genesis/releases/download/v0.1.1/genesis_0.1.1_linux_amd64.tar.gz"
		FTYPE=".tar.gz"
		;;
